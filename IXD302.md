...
For a more in-depth explanation of the module’s intent, including recommended reading, read the [abbreviated module descriptor](http://ixdbelfast.org/curriculum/0002/01/02/narrative-and-storytelling.html).
...
+ Outline of the Module
  ...
  + Assessment: A note on the deliverables and amount of effort I'm expecting. (This is a 20 Credit module, which equates to 200 effort hours, excluding the lectures, that's  Go through module report form to show where marks are awarded.
...
+ Speeding up your site, minification, the experience, etc.
+ Concatenation
+ Minification
+ Compression
...
This critique affords the students an opportunity to address any issues and to improve the quality of the submission before the January hand-in.
